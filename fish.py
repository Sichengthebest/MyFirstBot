...
def check_fish(user,fish,chatid):
    check_fishes(user)
...
def fish(update, context):
    ...
    if t >= get_gametime(user):
        update.message.reply_text("%s\n/fishbal to see the number of fish coins you have!\n/fishbal 来看看你有多少鱼币！\nCreator/作者: Sichengthebest"%result)
        check_fish(user,result,chatid)
